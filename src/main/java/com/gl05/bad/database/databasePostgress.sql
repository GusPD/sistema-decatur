...
ALTER TABLE CUOTA_MANTENIMIENTO
   DROP CONSTRAINT IF EXISTS FK_MANTENIMIENTO_INFO;
...
DROP INDEX IF EXISTS INFO_MANTENIMIENTO_FK;
...
CREATE INDEX INFO_MANTENIMIENTO_FK ON CUOTA_MANTENIMIENTO (ID_INFO_MANTENIMIENTO);
...
ALTER TABLE CUOTA_MANTENIMIENTO
ADD CONSTRAINT FK_MANTENIMIENTO_INFO FOREIGN KEY (ID_INFO_MANTENIMIENTO)
REFERENCES INFO_MANTENIMIENTO (ID_INFO_MANTENIMIENTO);
