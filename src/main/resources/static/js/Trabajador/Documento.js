$(document).ready(function() {
    ...
    var table = $('#documentoTable').DataTable({
        ajax: '/documentosTrabajador/data/'+idDocumento,
        processing: true,
        serverSide: true,
        order: [[1, 'asc']],
            ...
            { data: 'nombre', title: "Nombre", width: '60%' },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if(hasPrivilegeVerDocumento === true){
                        actionsHtml = '<a title="Ver" type="button" class="btn font-size-small btn-outline-secondary btn-sm" href="/DocumentoTrabajador/' + row.idDocumento + '">';
