            ...
            <div class="container">
                ...
                <div>
                    <div class="table-responsive-md table-container">
                        <table id="empresaTable" class="table table-striped custom-fixed-header">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Ten en cuenta que se eliminarán los datos relacionados a la empresa <span id="nombre"></span>.</p>
                </div>
                <div class="modal-footer">
