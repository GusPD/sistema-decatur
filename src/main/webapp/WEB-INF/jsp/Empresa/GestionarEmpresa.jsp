                            ...
                            <h3 class="card-title d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-end">
                                    <sec:authorize access="hasAuthority('AGREGAR_EMPRESA_PRIVILAGE')"> 
                                        <button type="button" title="Agregar Empresa" class="btn-blue btn abrirModal-btn ml-2" data-bs-toggle="modal" data-bs-target="#crearModal" data-action="agregar"><i class="fa-solid fa-file-pen"></i></button>
                                    </sec:authorize> 
                                </div>
                            </h3>
                        </div>
