                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link text-dark active" aria-current="page" href="/BackupLocal">Local</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-dark" aria-current="page" href="/BackupNube">Nube</a>
                            </li>
                        </ul>
...
<script src="${pageContext.request.contextPath}/js/Backup/BackupLocal.js"></script>
