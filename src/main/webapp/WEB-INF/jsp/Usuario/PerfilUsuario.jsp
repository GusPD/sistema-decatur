                                                            ...
                                                            <form id='formGuardar' accept-charset="UTF-8">
                                                                <div class="modal-body">
                                                                    <div  class="overflow-auto">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="password" class="form-label">Confirmar contraseña:<strong class="text-danger"> *</strong></label>
                                                                            <div class="input-group m-0 p-0">
                                                                                <input type="password" class="form-control form-control-sm" id="confirm_password" name="confirm_password" placeholder="Confirmar contraseña" required>
