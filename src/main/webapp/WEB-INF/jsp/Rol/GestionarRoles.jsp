                            ...
                            <h3 class="card-title d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-end">
                                    <sec:authorize access="hasAuthority('AGREGAR_ROL_PRIVILAGE')"> 
                                        <button type="button" title="Agregar Rol" class="btn-blue btn btn-sm abrirModal-btn ml-2" data-bs-toggle="modal" data-bs-target="#crearModal" data-action="agregar"><i class="fa-solid fa-file-pen"></i></button>
                                    </sec:authorize> 
                                </div>
                            </h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div id="table_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="col-sm-12 table-responsive pt-1" style="height: 60vh; padding:4px;">
                                    <table id="rolesTable" class="table table-bordered table-striped text-center dataTable dtr-inline mt-1"></table>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-flush-spacing" style="font-size: 13px">
                                        <tbody>
                                            ...
                                            <div>
                                                ...
                                                <c:set var="nombrePermisoLista" value="Cuenta Bancaria"/>
                                                ...
                                                <c:set var="nombrePermisoLista" value="Configuración Correo"/>
                                                <c:set var="permisoEvaluado1" value="${'AGREGAR_CONFIGURACION_CORREO'}"/>
                                                <c:set var="permisoEvaluado2" value="${'EDITAR_CONFIGURACION_CORREO'}"/>
                                                <c:set var="permisoEvaluado3" value="${'ELIMINAR_CONFIGURACION_CORREO'}"/>
                                                <c:set var="permisoEvaluado4" value="${'EXPORTAR_CONFIGURACION_CORREO'}"/>
                                                <c:set var="permisoEvaluado5" value="${'GESTIONAR_CONFIGURACION_CORREO'}"/>
                                                <tr>
                                                    <td class="w-70">
                                                        <div class="mt-1 mb-0 p-0 d-flex align-items-center">
                                                            <c:out value="${nombrePermisoLista}"/>
                                            ...
                                            <c:set var="nombrePermisoLista" value="Envío Correo"/>
                                            <c:set var="permisoEvaluado1" value="${'ENVIAR_CORREO_ELECTRONICO'}"/>
                                            <c:set var="permisoEvaluado2" value="${'GESTIONAR_ENVIO_CORREO_ELECTRONICO'}"/>
                                            <tr>
                                                <td colspan="3">
                                                    <div class="mt-1 mb-0 p-0 d-flex align-items-center">
                                                        <c:out value="${nombrePermisoLista}"/>
                                            ...
                                            <c:set var="nombrePermisoLista" value="Contactos"/>
                                            <c:set var="permisoEvaluado1" value="${'AGREGAR_CONTACTO'}"/>
                                            <c:set var="permisoEvaluado2" value="${'ELIMINAR_CONTACTO'}"/>
                                            <c:set var="permisoEvaluado3" value="${'EXPORTAR_CONTACTO'}"/>
                                            <c:set var="permisoEvaluado4" value="${'GESTIONAR_CONTACTO'}"/>
                                            <tr>
                                                <td colspan="3">
                                                    <div class="mt-1 mb-0 p-0 d-flex align-items-center">
                                                        <c:out value="${nombrePermisoLista}"/>
