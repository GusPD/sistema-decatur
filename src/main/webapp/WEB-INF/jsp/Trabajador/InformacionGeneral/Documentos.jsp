...
<!-- Script de la página -->
<sec:authorize access="hasAuthority('VER_DOCUMENTO_TRABAJADOR_PRIVILAGE')" var="hasPrivilegeVerDocumento"></sec:authorize>
<script>var hasPrivilegeVerDocumento = <c:out value='${hasPrivilegeVerDocumento}' />;</script>    

<sec:authorize access="hasAuthority('ELIMINAR_DOCUMENTO_TRABAJADOR_PRIVILAGE')" var="hasPrivilegeEliminarDocumento"></sec:authorize>
...
<script src="${pageContext.request.contextPath}/js/Trabajador/Documento.js"></script>
